...
if Settings.isLinux() or Settings.isWindows():
    ...
    if not exists("Multiplayer-Client-TeamName-FilledIn-160422-VVD-0.1.png", 2):
        paste("Multiplayer-Client-TeamName-Blank-160422-VVD-0.1.png", "QA")
    ...
    if not exists("Multiplayer-Client-StakeholderSelection-ChooseStakeholderBtn-160422-VVD-0.1.png"):
        click(Pattern("Multiplayer-Client-StakeholderSelectionList-160422-VVD-0.1.png").targetOffset(-28,-37))
    if not exists("Multiplayer-Client-StakeholderSelection-ChooseStakeholderBtn-160422-VVD-0.1.png"):
        click(Pattern("Multiplayer-Client-StakeholderSelectionList-160422-VVD-0.1.png").targetOffset(-92,34))
    if not exists("Multiplayer-Client-StakeholderSelection-ChooseStakeholderBtn-160422-VVD-0.1.png"):
        click(Pattern("Multiplayer-Client-StakeholderSelectionList-160422-VVD-0.1.png").targetOffset(-83,117))
...
if Settings.isMac():
    ...
    if not exists("Multiplayer-MAC-Client-TeamName-FilledIn-160425-VVD-0.1.png", 2):
        paste("Multiplayer-Client-MAC-TeamName-Blank-160425-VVD-0.1.png", "QA")
    Region(805,541,874,467)
    ...
    click(Pattern("Multiplayer-Client-MAC-StakeholderSelectionList-160425-VVD-0.1.png").targetOffset(-32,-122))
    if not exists("Multiplayer-Client-MAC-StakeholderSelection-ChooseStakeholderBtn-160425-VVD-0.1.png"):
        click(Pattern("Multiplayer-Client-MAC-StakeholderSelectionList-160425-VVD-0.1.png").targetOffset(-28,-37))
    if not exists("Multiplayer-Client-MAC-StakeholderSelection-ChooseStakeholderBtn-160425-VVD-0.1.png"):
        click(Pattern("Multiplayer-Client-MAC-StakeholderSelectionList-160425-VVD-0.1.png").targetOffset(-92,34))
    if not exists("Multiplayer-Client-MAC-StakeholderSelection-ChooseStakeholderBtn-160425-VVD-0.1.png"):
        click(Pattern("Multiplayer-Client-MAC-StakeholderSelectionList-160425-VVD-0.1.png").targetOffset(-83,117))
