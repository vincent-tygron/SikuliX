...
print"[info]===== Uploading first set of custom assets ====="
logging.info("[info]===== Uploading first set of custom assets =====")
...
wait(Pattern("1459769876588.png").similar(0.65), 10)
...
print"[info]===== Finished uploading first set of custom assets ====="
logging.info("[info]===== Finished uploading first set of custom assets =====")
