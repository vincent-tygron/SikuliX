...
print"[info]===== Starting a SP session and check for original custom assets ====="
logging.info("[info]===== Starting a SP session and check for original custom assets =====")
...
print"[info]===== Ending/ saving a SP session with original custom assets ====="
logging.info("[info]===== Ending/ saving a SP session with original custom assets =====")