...
print"[info]===== Uploading updated set of custom assets ====="
logging.info("[info]===== Uploading updated set of custom assets =====")
...
#click(Pattern("1459863644086.png").similar(0.71).targetOffset(249,201))
click("1462197110063.png")
...
print"[info]===== Finished uploading updated set of custom assets ====="
logging.info("[info]===== Finished uploading updated set of custom assets =====")
